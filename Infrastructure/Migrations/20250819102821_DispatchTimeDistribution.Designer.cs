...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250819102821_DispatchTimeDistribution")]
    partial class DispatchTimeDistribution
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d2d8f7e1-f63c-46f1-b8b4-43c5f3c2f3e1",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "3c8f59e7-56de-4bc5-bf71-2e29b1a769f9",
                            Name = "Patient",
            ...
            modelBuilder.Entity("Core.Entities.Photo", b =>
                {
                    b.HasOne("Core.Entities.Product", "Product")
                        .WithOne("Photo")
                        .HasForeignKey("Core.Entities.Photo", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
